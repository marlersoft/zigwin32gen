...
pub fn BaseWindow(comptime DERIVED_TYPE: type) type {
    return struct {
        ...
        pub fn Create(
            ...
            self.m_hwnd = win32.CreateWindowEx(options.dwExStyle, DERIVED_TYPE.ClassName(), lpWindowName, dwStyle, options.x, options.y, options.nWidth, options.nHeight, options.hWndParent, options.hMenu, win32.GetModuleHandle(null), @ptrCast(*anyopaque, self));
