...
pub usingnamespace if (@sizeOf(usize) == 8) struct {
    pub const SetWindowLongPtrA = win32.api.ui.windows_and_messaging.SetWindowLongPtrA;
    pub const SetWindowLongPtrW = win32.api.ui.windows_and_messaging.SetWindowLongPtrW;
    pub const GetWindowLongPtrA = win32.api.ui.windows_and_messaging.GetWindowLongPtrA;
    pub const GetWindowLongPtrW = win32.api.ui.windows_and_messaging.GetWindowLongPtrW;
} else struct {
    pub const SetWindowLongPtrA = win32.api.ui.windows_and_messaging.SetWindowLongA;
    pub const SetWindowLongPtrW = win32.api.ui.windows_and_messaging.SetWindowLongW;
    pub const GetWindowLongPtrA = win32.api.ui.windows_and_messaging.GetWindowLongA;
    pub const GetWindowLongPtrW = win32.api.ui.windows_and_messaging.GetWindowLongW;
};
